...
So far, I cultivated my interest in HCI more focous on olfactory interaction by exploring a range of topics. Gradually, I found they formed three aspects: (1) **scent releasing methods** base on hardwares of olfactory displays (IJHCI), (2) **olfactory feedback in different scanio context** (CHI’25, IJHCI), (3) **crossmodal sensory inflencen** in virtual environment (CHI’25, DIS’25).
